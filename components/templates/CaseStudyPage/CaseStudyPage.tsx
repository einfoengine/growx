...
export default function CaseStudyPage({ caseStudy: cs, related }: Props) {
  ...
  return (
    <>
      {/* ── Hero ─────────────────────────────────────────────── */}
      <section id="gw-case-study-hero" className="relative overflow-hidden bg-background">
        <div
          aria-hidden="true"
      ...
      {/* ── Results Bar ──────────────────────────────────────── */}
      <section id="gw-case-study-results" className="border-y border-border bg-surface">
      ...
      {/* ── Challenge & Solution ─────────────────────────────── */}
      <section id="gw-case-study-challenge" className="bg-background">
      ...
      {/* ── Services Used ────────────────────────────────────── */}
      <section id="gw-case-study-scope" className="bg-surface">
      ...
      {/* ── Testimonial ──────────────────────────────────────── */}
      {cs.testimonial && (
        <section id="gw-case-study-testimonial" className="bg-background">
      ...
      {related.length > 0 && (
        <section id="gw-case-study-related" className="bg-surface">
          <div className="container-1200 py-20 sm:py-24">
      ...
      {/* ── Bottom CTA ───────────────────────────────────────── */}
      <section id="gw-case-study-cta" className="relative isolate overflow-hidden bg-foreground text-background">
        <div
          aria-hidden="true"
        ...
        <div className="container-1200 py-24">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Button label="All case studies" href="/case-studies" variant="secondary" darkBg />
          </div>
        </div>
      </section>
    </>

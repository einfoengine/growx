...
export default function CaseStudiesPage({ caseStudies }: Props) {
  return (
    <>
      {/* ── Hero ─────────────────────────────────────────────── */}
      <section id="gw-case-studies-hero" className="relative overflow-hidden bg-background">
        <div
          aria-hidden="true"
      ...
      {/* ── Case Study Grid ──────────────────────────────────── */}
      <section id="gw-case-studies-grid" className="bg-surface">
      ...
      {/* ── Bottom CTA ───────────────────────────────────────── */}
      <section id="gw-case-studies-cta" className="relative overflow-hidden bg-background">
        <div
          aria-hidden="true"
        ...
        <div className="container-1200 py-24">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Button label="View all services" href="/#gw-mod-services" variant="secondary" />
          </div>
        </div>
      </section>
    </>

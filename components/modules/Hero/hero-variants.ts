...
> = {
  ...
  inner: {
    shell: "container-1200 relative pt-28 pb-20 sm:pt-32 sm:pb-24 lg:pt-36 lg:pb-28",
    headline:
      "mt-7 text-5xl font-extrabold leading-[1.15] tracking-tight text-background sm:text-6xl lg:text-7xl xl:text-8xl",
    tagline: "mt-6 text-base font-semibold tracking-tight text-background/90 sm:text-lg",
